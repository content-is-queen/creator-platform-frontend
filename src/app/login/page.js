...
const Login = () => {
  ...
  return (
    ...
    <button type="submit" className="text-white bg-queen-orange hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 auth-btn">{isSigningIn ? 'SIGNING IN...' : 'SIGN IN'}</button>
  </form>
    </AuthTemplate>
  );
};
