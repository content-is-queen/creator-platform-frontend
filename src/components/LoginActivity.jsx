  ...
  <section className="grid grid-cols-1 md:grid-cols-2 h-screen">
    ...
    <div>
      <div className="login_container bg-queen-white flex justify-center items-center h-full">
        <form className="p-2">
          <h1 className="uppercase text-queen-black login-title font-anton">welcome back</h1>
          <div className="relative z-0 w-full mb-5 group">
            ...
            <label htmlFor="floating_email" className="peer-focus:font-medium absolute text-lg text-queen-black  duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Email address</label>
          </div>
          <div className="relative z-0 w-full mb-5 group">
          ...
          <Link to="/signup" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Sign Up</Link>
        </form>
      </div>
    </div>
  </section>
